...
class DayUtil {
    public static func getYearMonthDayByDayId(_ dayId: Int) -> Int {
        ...
        let yValue = gValue * 400 + cValue * 100 + bValue * 4 + aValue // this is the integer number of full years elapsed since March 1, 4801 BC at 00:00 UTC
        let mValue = (daValue * 5 + 308) / 153 - 2 // this is the integer number of full months elapsed since the last March 1 at 00:00 UTC
        let dValue = daValue - (mValue + 4) * 153 / 5 + 122 // this is the number of days elapsed since day 1 of the month at 00:00 UTC
